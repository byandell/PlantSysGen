...
pdf("../Figs/causal_network_bw.pdf", height=6, width=10, pointsize=32)
...
text(x[2], y[1], expression(r[3]))
text(x[2], y[3], expression(r[2]))
text(x[2], y[5], expression(r[1]))

text(x[3], y[3], expression(y))
text(x[4], y[3], expression(r[4]))
